import sqlite3
#inportavom sqlite3 
#LENTELIU KURIMAS SU PYTHON
#TEORIJA 16_DB/db_python FOLDERYJE
connector = sqlite3.connect('draugai.db')
cursor = connector.cursor()
#susikuria prisijungimo objektas connector. Jei pries tai nebuvo failo draugai.db, ji sukuria automatiskai.
#jo bagrindu susikure kursoriaus objektas cursor. Su jo metodais vykdomos SQL uzklausos.
...
'''
#query yra musu SQL uzklausa.

    cursor.execute(query)
    connector.commit()
#i kursoriaus metoda execute parametrus dedame savo uklausa vykdymui
#connector.commit isaugo pakeitimus duomenu bazeje 
...
if __name__ == '__main__':
    ...
    connector.close()
#connector.close uzddarome atidaryta prisijungima.